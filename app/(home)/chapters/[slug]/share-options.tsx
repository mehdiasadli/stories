...
export function ChapterShareOptions({ chapterTitle, chapterUrl }: ChapterShareOptionsProps) {
  ...
  const shareOptions = [
    {
      value: 'copy-link',
      label: 'linki kopyala',
      action: () => copyToClipboard(chapterUrl),
    },
    {
      value: 'facebook',
      label: 'facebook',
      action: () => shareOnFacebook(chapterTitle, chapterUrl),
    },
    {
      value: 'whatsapp',
      label: 'whatsapp',
      action: () => shareOnWhatsApp(chapterTitle, chapterUrl),
    },
    {
      value: 'telegram',
      label: 'telegram',
      action: () => shareOnTelegram(chapterTitle, chapterUrl),
    },
    {
      value: 'twitter',
      label: 'twitter',
      action: () => shareOnTwitter(chapterTitle, chapterUrl),
    },
  ];
  ...
  const shareOnWhatsApp = (title: string, url: string) => {
    const text = `"${title}" bölümünü oxu ("mahmud")`;
